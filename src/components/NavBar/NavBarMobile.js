  ...
  return (
    <motion.div
      ...
      <nav className='flex items-center justify-center flex-wrap mt-2  [&>a]:w-6'>
        <motion.a href={'https://twitter.com/ezzu399'} target={'_blank'} className='mr-3 sm:mx-1' whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} > <TwitterIcon /></motion.a>
        <motion.a href={'https://github.com/ezzu'} target={'_blank'} className='mx-3 bg-light dark:bg-dark rounded-full sm:mx-1' whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }}><GithubIcon /></motion.a>
        <motion.a href={'https://www.linkedin.com/in/ertiza-ejaz/'} target={'_blank'} className='mx-3 sm:mx-1' whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }}><LinkedInIcon /></motion.a>
